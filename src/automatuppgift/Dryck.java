...
public class Dryck extends Produkter implements Interface{
    //Konstrtuktor tar in parametrar för Produkter-attribut samt sitt eget attribut.
    public Dryck(String name, int price, String description){
    ...
    public void Use() {
        System.out.println("Hoppas drycken är god!");    }
}
